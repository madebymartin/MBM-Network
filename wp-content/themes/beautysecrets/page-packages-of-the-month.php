...
?>
		...
		<?php the_post_thumbnail('pagefeature'); ?> 
	</div><!-- homeslides -->
...
'order' => 'ASC'
			...
			<?php if ( get_post_meta(get_the_ID(), 'rw_packageofthemonth', true) ) { ?>
			<h1 class="treatment-name"><?php the_title(); ?></h1>
<p>Available at:</p>
<ul>
...
<?php 	wp_nav_menu( array('menu' => 'Feature Page' )); ?>
</div>
