...
<!-- results count -->
<div class="results-count-wrapper center">
...
<aside id="secondary" class="widget-area" role="complementary">
	<section id="woocommerce_layered_nav-5" class="widget woocommerce widget_layered_nav">
		...
		<div class="gmw-results-wrapper gmw-results-wrapper-<?php echo $gmw['ID']; ?> gmw-pt-purple-results-wrapper">
			...
			<!-- <div class="pagination-per-page-wrapper top"> -->
				<!--  paginations -->
			<?php 
			//gmw_per_page( $gmw, $gmw['total_results'], 'paged' ); ?><?php gmw_pagination( $gmw, 'paged', $gmw['max_pages'] ); 
			?>
			<!-- </div>  -->
...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		 <!-- GEO my WP Map -->
	    <?php if ( $gmw['search_results']['display_map'] == 'results' ) {
	        gmw_results_map( $gmw );
	    } ?>
