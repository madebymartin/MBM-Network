...
/* Add Recommendation Post Type */
    register_post_type( 'recommendation',
        array(
            ...
            'supports' => array(
                'title', 'editor', 'custom-fields', 'author'),
            'menu_position' => '9',
            'can_export' => true,
            'taxonomies' => array('') // this is IMPORTANT
        )
    ...
    register_post_type( 'promotion',
        array(
            'labels' => array(
                ...
                'add_new_item' => __( 'Add Promotion' ),
                'edit' => __( 'Edit Promotion' ),
                'edit_item' => __( 'Edit Promotion' ),
                'new_item' => __( 'Add New Promotion' ),
                'view' => __( 'View This Promotion' ),
                'view_item' => __( 'View This Promotion' ),
                'search_items' => __( 'Search Promotions' ),
                'not_found' => __( 'No Promotions Found' ),
                'not_found_in_trash' => __( 'No Promotions found in Trash' ),
            ),
            'description' => __('Promotions'),
            'public' => true,
            'show_ui' => true, // UI in admin panel
            'capability_type' => 'post',
            'hierarchical' => true,
            'rewrite' => array("slug" => "promotion"), // Permalinks format
            'publicly_queryable' => true,
            'exclude_from_search' => false,
            'menu_position' => 20,
...
/* Add Accoutn Manager Post Type */
    register_post_type( 'account_manager',
        array(
            'labels' => array(
                'name' => __( 'Acc. Managers' ),
                'singular_name' => __( 'Account Manager' ),
                'add_new' => __( 'Add Account Manager' ),
                'add_new_item' => __( 'Add Account Manager' ),
                'edit' => __( 'Edit Account Manager' ),
                'edit_item' => __( 'Edit Account Manager' ),
                'new_item' => __( 'Add New Account Manager' ),
                'view' => __( 'View This Account Manager' ),
                'view_item' => __( 'View This Account Manager' ),
                'search_items' => __( 'Search Account Managers' ),
                'not_found' => __( 'No Account Managers Found' ),
                'not_found_in_trash' => __( 'No Account Managers found in Trash' ),
            ),
            'description' => __('Account Managers'),
            'public' => false,
            'show_ui' => true, // UI in admin panel
            'capability_type' => 'post',
            'hierarchical' => true,
            'rewrite' => array("slug" => "account_manager"), // Permalinks format
