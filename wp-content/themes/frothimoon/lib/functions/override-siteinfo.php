...
?>
<a class="homelink" href="<?php get_bloginfo('url'); ?> "></a>
<a class="facebook" href="http://www.facebook.com/frothimoon" target="blank">Find Us On Facebook</a>
...
<li>Copyright © Frothimoon <?php echo date('Y'); ?></li>
