...
<head>
 ...
 <body>
     <div id="page" itemtype="https://schema.org/LocalBusiness" itemscope="itemscope">
     <!-- tr class=row -->
           <div class="comments">
               ...
               <span>
                   <a>
                       <xsl:attribute name="href"><xsl:value-of select="concat('https://www.feefo.com/feefo/viewvendor.jsp?logon=',VENDORLOGON)"/></xsl:attribute>
                       <img itemprop="image">
