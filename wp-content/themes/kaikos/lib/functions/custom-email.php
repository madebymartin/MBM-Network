...
add_action('order_status_pending_to_processing', 'jigoshop_new_order_notification_ucw');
add_action('order_status_pending_to_completed', 'jigoshop_new_order_notification_ucw');
add_action('order_status_pending_to_on-hold', 'jigoshop_new_order_notification_ucw');

function jigoshop_new_order_notification_ucw($order_id) {
...
add_action('order_status_pending_to_processing', 'jigoshop_processing_order_customer_notification_ucw');
add_action('order_status_pending_to_on-hold', 'jigoshop_processing_order_customer_notification_ucw');

function jigoshop_processing_order_customer_notification_ucw( $order_id ) {
...
add_action('order_status_completed', 'jigoshop_completed_order_customer_notification_ucw');



function jigoshop_completed_order_customer_notification_ucw($order_id) {
...
echo '=====================================================================' . PHP_EOL;
echo 'Thanks again for shopping with Universal Contour Wrap' . PHP_EOL;
echo '=====================================================================' . PHP_EOL;
