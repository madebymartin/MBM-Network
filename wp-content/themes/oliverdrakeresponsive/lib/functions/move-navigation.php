...
// Create #access above the main asides IF ON FRONT PAGE ELSE - ABOVE ASIDES
    function my_accesshome() {
		if(is_front_page() ) {
			thematic_access();
		} 
    }
    add_action('thematic_belowheader','my_accesshome', 1); 
...
// Create #access above the main asides IF ON FRONT PAGE ELSE - ABOVE ASIDES
    ...
    add_action('thematic_abovemainasides','my_access', 1);
