...
<br><br>
				...
				<h4>If you would like to change your password<br>please type a new one.<br> Otherwise leave this blank</h4>
...
?>
<a class="button" href="<?php echo wp_logout_url( get_permalink() ); ?>" title="Logout">Logout</a>
