 ...
 */
    class stnsvn_about_widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'stnsvn-about-widget', 
			'description' => __('Create a styled "About me" section', 'paloma'),
			);

		$control_ops = array(
			'width' => 400, 
			'height' => 350, 
			'id_base' => 'stnsvn_about_widget',
			);

		parent::__construct( 'stnsvn_about_widget', __( 'Station Seven About Me Widget', 'paloma' ), 
...
// register widget
    add_action('widgets_init', create_function('', 'return register_widget("stnsvn_about_widget");'));