...
<div id="page" class="site">
	...
	<div class="fullscreen-bg">
	    ...
	    <video loop muted autoplay poster="<?php echo get_stylesheet_directory_uri() ?>/img/background.png" class="fullscreen-bg__video">   

			<source src="<?php echo get_stylesheet_directory_uri(); ?>/inc/video/homepagevideo.webm" type="video/webm">
