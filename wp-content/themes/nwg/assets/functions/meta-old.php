<?php
add_filter( 'rwmb_meta_boxes', 'mbm_meta_boxes' );
function mbm_meta_boxes( $meta_boxes ) {
    ...
    // 2nd meta box
    $meta_boxes[] = array(
        'title' => esc_html__( 'Slideshow Images', 'chalk_and_brown' ),
        'post_types' => array( 'page' ),
        'fields' => array(
            // IMAGE ADVANCED - RECOMMENDED
            array(
                'name'             => esc_html__( 'Slide Images', 'chalk_and_brown' ),
                'id'               => $prefix . 'slides',
                'type'             => 'image_advanced',
                'force_delete'     => false,
                'max_file_uploads' => 8,
        ...
        $meta_boxes[] = array(
        'title' => esc_html__( 'Photos', 'chalk_and_brown' ),
