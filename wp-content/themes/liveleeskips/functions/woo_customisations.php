	...
	function mbm_woocommerce_product_archive_description() {
		...
		if ( is_post_type_archive( 'product' ) && 0 === absint( get_query_var( 'paged' ) ) ) {
			...
			if ( $shop_page ) {
				...
				<iframe id="base-location" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d79692.74519789474!2d-0.45728028544795585!3d51.37735754741348!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876752fe2a26361%3A0xb6e82914c3a926b8!2sWalton-on-Thames+KT12+3PB!5e0!3m2!1sen!2suk!4v1492533232689" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
...
if(!function_exists('mbm_remove_wc_actions')){
	function mbm_remove_wc_actions(){
		...
		add_action('woocommerce_after_shop_loop_item_title', 'mbm_skip_spec', 12);
...
if(!function_exists('mbm_skip_spec')){
	function mbm_skip_spec(){
		...
		echo '<div class="row bags"><span class="spec">Bin Bags: '. $bins .'<small> approx</small></span>';
