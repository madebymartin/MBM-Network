...
<div id="wl-wrapper" class="woocommerce">
	...
	<?php if ($lists && count($lists)) : ?>
					...
					<?php foreach ($lists as $list) : ?>
						...
						<tr class="cart_table_item">
							...
							<td class="wl-privacy-col">
								<select class="wl-priv-sel" name="sharing[<?php echo $list->id; ?>]" onchange="this.form.submit()">
	        ...
	        <div class="wl-row">
				<a href="<?php echo WC_Wishlists_Pages::get_url_for('create-a-list'); ?>" class="button alt wl-create-new"><?php _e('Create another List', 'wc_wishlist'); ?></a>
			</div>
