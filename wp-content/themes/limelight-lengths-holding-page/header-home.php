...
<!-- 	    <video loop muted autoplay poster="<?php echo get_stylesheet_directory_uri() ?>/img/bg.jpg" class="fullscreen-bg__video">   
		...
		<header id="masthead" class="site-header-fullpage" role="banner">
			...
			<a id="home" href="<?php echo get_site_url(); ?>"><img src="<?php echo get_stylesheet_directory_uri() . '/img/lll-logo.svg'; ?>" alt="<?php echo get_bloginfo( 'name' ); ?>"></a>
			<p style="color:#9bbd39;width:100%;text-align: center;letter-spacing:5px;margin-top:3rem;">COMING SOON</p>
