...
;(function($) {
	...
	$.anythingSlider.defaults = {
		...
		easing              : "easeInOutQuart",   // Anything other than "linear" or "swing" requires the easing plugin or jQuery UI
...
*/
		...
		// Times
		delay               : 4200,      // How long between slideshow transitions in AutoPlay mode (in milliseconds)
