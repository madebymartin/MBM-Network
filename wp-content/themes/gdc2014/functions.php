...
require_once( 'lib/functions/gf_survey_coupon.php' );
...
// ASYNCRONOUSLY LOAD ENQUEUED SCRIPTS
...
function skx_create_pdf($order_id){
    ...
    if( order_contains_skx($order_id) ){
        ...
        mbm_write_log('SKX sample set IS in this order - PDF created');
    }
    else{mbm_write_log('SKX sample set NOT in this order - No PDF created');}
