...
add_action( 'cmb2_admin_init', 'mbm_register_page_metaboxes' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function mbm_register_page_metaboxes() {
	$prefix = 'mbm_';

	/**
	 * Sample metabox to demonstrate each field type included
	 */
/*	$cmb_page_meta = new_cmb2_box( array(
		'id'            => $prefix . 'slideshow',
		'title'         => esc_html__( 'Slideshow Images', 'cmb2' ),
		'object_types'  => array( 'page', ), // Post type
	) );

	$cmb_page_meta->add_field( array(
		'name'         => esc_html__( 'Slideshow Images', 'cmb2' ),
		'desc'         => esc_html__( 'Set a single image or multiples for a slideshow.', 'cmb2' ),
		'id'           => $prefix . 'slides',
		'type'         => 'file_list',
...
*/
	...
	$cmb_page_options = new_cmb2_box( array(
        'id'            => $prefix . 'pageoptions',
    ...
    $cmb_page_options->add_field( array(
		'name' => esc_html__( 'Heading Color', 'cmb2' ),
		'desc' => esc_html__( 'Dark: #3F4B52 | Green: #9CB935 | White: #ffffff', 'cmb2' ),
	...
	$cmb_page_fields = new_cmb2_box( array(
        'id'            => $prefix . 'pagerows',
        'title'         => __( 'Page Rows', 'cmb2' ),
        'object_types'  => array( 'page' ), // Post type
        'context'       => 'normal',
        'priority'      => 'high',
        'show_names'    => true, // Show field names on the left
    ...
    // Repeatable group
    $page_group = $cmb_page_fields->add_field( array(
        'id'          => $prefix . 'rows',
        'type'        => 'group',
        'options'     => array(
    ...
    // Main editor
    $cmb_page_fields->add_group_field( $page_group, array(
...
function mbm_register_repeatable_group_field_metabox() {
	...
	$cmb_project_group = new_cmb2_box( array(
		'id'           => $prefix . 'photos',
		'title'        => esc_html__( 'Photos', 'cmb2' ),
		'object_types' => array( 'project', ),
	) );

	// $group_field_id is the field id string, so in this case: $prefix . 'demo'
	$group_field_id = $cmb_project_group->add_field( array(
		'id'          => $prefix . 'photos_group',
		'type'        => 'group',
		'description' => esc_html__( 'Generates reusable form entries', 'cmb2' ),
		'options'     => array(
			'group_title'   => esc_html__( 'Photo {#}', 'cmb2' ), // {#} gets replaced by row number
	 ...
	 */
	$cmb_project_group->add_group_field( $group_field_id, array(
		'name'       => esc_html__( 'Photo', 'cmb2' ),
		'id'         => 'photo',
		'type'       => 'file',
		'repeatable' => false, // Repeatable fields are supported w/in repeatable groups (for most types)
		'classes'    => 'col-6', // Extra cmb2-wrap classes
	) );

	$cmb_project_group->add_group_field( $group_field_id, array(
		'name'        => esc_html__( 'Description', 'cmb2' ),
		'description' => esc_html__( 'Optional description', 'cmb2' ),
		'id'          => 'description',
		'type'        => 'textarea_small',
		'classes'    => 'col-6',
	) );
